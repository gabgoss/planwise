...
*Cross-references: [session-planning-protocol.md](session-planning-protocol.md) (plan hierarchy and naming), [task-file-and-tracking-requirements.md](task-file-and-tracking-requirements.md) (Required Context and task-file structure), [task-content-fidelity.md](task-content-fidelity.md) (§9.A Required Context fidelity, §9.B verify-before-cite), [scaffolding-hygiene.md](scaffolding-hygiene.md) §11 (mega-scaffold review-gate — the scaffold-time enforcement that prevents [destructive-change-requirements.md](destructive-change-requirements.md) §10.1 promises from being silently introduced).*
